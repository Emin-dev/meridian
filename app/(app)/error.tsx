  ...
  return (
    <div className="flex items-center justify-center py-24">
      <div className="w-full max-w-md rounded-xl border border-[--line-1] bg-[--surface-1] px-8 py-10 text-center">
        <div className="mx-auto mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-[--bad-tint]">
          <AlertCircleIcon size={20} className="text-[--bad]" aria-hidden="true" />
        </div>
